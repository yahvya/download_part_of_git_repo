...
# php copy_git.php {owner} {repo} {path_to_data} {true if you need to get the full path when download something or false (default value is true)} {github access token (optional) if you want to get more api call}
